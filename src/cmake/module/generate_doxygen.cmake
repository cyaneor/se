...
if (DOXYGEN_FOUND)
    ...
    set(DOXYGEN_IN ${SE_CMAKE_CURRENT_SOURCE_DIR}/.doxyfile.in)

    # Указываем путь к выходному файлу конфигурации Doxygen (doxygen), который будет сгенерирован
    set(DOXYGEN_OUT ${SE_CMAKE_CURRENT_BINARY_DIR}/doxygen)
    ...
    add_custom_target(${PROJECT_NAME}_docs ALL
            ...
            WORKING_DIRECTORY ${SE_CMAKE_CURRENT_BINARY_DIR}
