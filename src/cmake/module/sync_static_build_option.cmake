...
# Проверяем, есть ли макрос "SE_LIBRARY_OPTION_STATIC_BUILD" в списке SE_TARGET_PRIVATE_COMPILE_DEFINITIONS
list(FIND SE_TARGET_PRIVATE_COMPILE_DEFINITIONS "SE_LIBRARY_OPTION_STATIC_BUILD" index)
...
if (index GREATER -1)
    ...
    list(APPEND SE_TARGET_PUBLIC_COMPILE_DEFINITIONS "SE_LIBRARY_OPTION_STATIC_BUILD")

    # Удаляем макрос из приватного списка, так как он должен быть доступен и для другого проекта
    list(REMOVE_AT SE_TARGET_PRIVATE_COMPILE_DEFINITIONS ${index})
endif ()