...
if (SE_LIBRARY_OPTION_STATIC_BUILD)
    ...
    add_library(${PROJECT_NAME} STATIC ${SE_TARGET_SOURCE_FILES})
elseif (SE_LIBRARY_OPTION_SHARED_BUILD)
    ...
    add_library(${PROJECT_NAME} SHARED ${SE_TARGET_SOURCE_FILES})
else ()
    # Если ни одна из предыдущих переменных не установлена, создаём исполняемый файл
    add_executable(${PROJECT_NAME} ${SE_TARGET_SOURCE_FILES})
endif ()
