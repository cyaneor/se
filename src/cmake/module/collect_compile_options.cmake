...
foreach (CMAKE_OPTION IN ITEMS ${CMAKE_OPTIONS})
    if (CMAKE_OPTION MATCHES "^SE_COMPILE_OPTION_.*")
        ...
        if (CMAKE_OPTION STREQUAL "SE_COMPILE_OPTION_SSE")
            if (${CMAKE_OPTION} STREQUAL "ON")
                if (CMAKE_C_COMPILER_ID STREQUAL "GNU")
                    list(APPEND SE_TARGET_PRIVATE_COMPILE_OPTIONS -msse)
                elseif (CMAKE_C_COMPILER_ID STREQUAL "Clang")
                    list(APPEND SE_TARGET_PRIVATE_COMPILE_OPTIONS -msse)
                elseif (CMAKE_C_COMPILER_ID STREQUAL "MSVC")
                    if (MSVC_VERSION LESS 1900)
                        list(APPEND SE_TARGET_PRIVATE_COMPILE_OPTIONS /arch:SSE)
        ...
        if (CMAKE_OPTION STREQUAL "SE_COMPILE_OPTION_AVX")
            if (${CMAKE_OPTION} STREQUAL "ON")
                if (CMAKE_C_COMPILER_ID STREQUAL "GNU")
                    list(APPEND SE_TARGET_PRIVATE_COMPILE_OPTIONS -mavx)
                elseif (CMAKE_C_COMPILER_ID STREQUAL "Clang")
                    list(APPEND SE_TARGET_PRIVATE_COMPILE_OPTIONS -mavx)
                elseif (CMAKE_C_COMPILER_ID STREQUAL "MSVC")
                    list(APPEND SE_TARGET_PRIVATE_COMPILE_OPTIONS /arch:AVX)
                endif ()
            endif ()
            continue()
        endif ()
        ...
        if (SE_COMPILE_OPTION_AVX512)
            if (CMAKE_C_COMPILER_ID STREQUAL "GNU")
                list(APPEND SE_TARGET_PRIVATE_COMPILE_OPTIONS -mavx512f)
            elseif (CMAKE_C_COMPILER_ID STREQUAL "Clang")
                list(APPEND SE_TARGET_PRIVATE_COMPILE_OPTIONS -mavx512f)
            elseif (CMAKE_C_COMPILER_ID STREQUAL "MSVC")
                list(APPEND SE_TARGET_PRIVATE_COMPILE_OPTIONS /arch:AVX512)
            endif ()
        endif ()
        ...
        if (CMAKE_OPTION STREQUAL "SE_COMPILE_OPTION_LTO")
            if (${CMAKE_OPTION} STREQUAL "ON")
                ...
                elseif (CMAKE_C_COMPILER_ID STREQUAL "MSVC")
                    list(APPEND SE_TARGET_PRIVATE_COMPILE_OPTIONS /GL)  # MSVC аналог LTO
                endif ()
            endif ()
            continue()
        endif ()
