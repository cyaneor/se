 ...
 */
#define se_ptr_aligned(ptr, align) se_addr_check_alignment(se_ptr_to_addr(ptr), align)
 ...
 */
#define se_ptr_pair_aligned(ptr1, ptr2, align)                                                     \
    (se_ptr_aligned(ptr1, align) && se_ptr_aligned(ptr2, align))

/**
 * @def se_ptr_ranges_aligned
 ...
 * @note Выравнивание `align` не должно быть нулевым.
 */
#define se_ptr_ranges_aligned(r1_begin, r1_end, r2_begin, r2_end, align)                           \
    (se_ptr_pair_aligned(r1_begin, r1_end, align) && se_ptr_pair_aligned(r2_begin, r2_end, align))
 ...
 */
#define se_ptr_ranges_overlap(r1_begin, r2_begin, r2_end)                                          \
    (!se_ptr_ranges_no_overlap(r1_begin, r2_begin, r2_end))

/**
 * @def se_ptr_range_size
 ...
 * @endcode
 */
#define se_ptr_range_size(begin, end, type_size) (se_ptr_to_addr_diff(end, begin) / (type_size))

/**
 * @def se_ptr_range_valid
 ...
 */
#define se_ptr_range_valid(begin, end) (begin && se_interval_valid_closed(begin, end))
 ...
 */
#define se_ptr_ranges_valid(r1_begin, r1_end, r2_begin, r2_end)                                    \
    (se_ptr_range_valid(r1_begin, r1_end) && se_ptr_range_valid(r2_begin, r2_end))
