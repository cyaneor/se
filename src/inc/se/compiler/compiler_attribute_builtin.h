 ...
 *
 * Этот файл предоставляет макрос `SE_COMPILER_ATTRIBUTE_BUILTIN`, который определяет
 ...
 *
 * Макросы:
 * - `SE_COMPILER_ATTRIBUTE_BUILTIN`:
 *    Принудительная инлайнизация функции.
 */

#ifndef SE_COMPILER_ATTRIBUTE_BUILTIN_H
#define SE_COMPILER_ATTRIBUTE_BUILTIN_H

#include "compiler_type.h"

#if (SE_COMPILER_TYPE == SE_COMPILER_TYPE_GCC) || (SE_COMPILER_TYPE == SE_COMPILER_TYPE_CLANG)
/**
 * @def SE_COMPILER_ATTRIBUTE_BUILTIN
 ...
 */
#    define SE_COMPILER_ATTRIBUTE_BUILTIN __attribute__((always_inline)) inline
 ...
 */
#    define SE_COMPILER_ATTRIBUTE_BUILTIN __forceinline
#else
/**
 * @def SE_COMPILER_ATTRIBUTE_BUILTIN
 ...
 */
#    define SE_COMPILER_ATTRIBUTE_BUILTIN

#    pragma message("Warning: Compiler does not support builtin attribute")
#endif

#endif // SE_COMPILER_ATTRIBUTE_BUILTIN_H
